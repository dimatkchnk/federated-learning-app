...
def prepare_plot(origImage, origMask, predMask, imgRes):
    ...
    ax[3].set_title("Applied u-net mask")
...
def make_predictions(model, imagePath):
    ...
    with torch.no_grad():
        ...
        predMask = cv2.resize(predMask, (orig.shape[1], orig.shape[0]))

        img_res = cv2.bitwise_and(orig, orig, mask=predMask)

        # prepare a plot for visualization
        prepare_plot(orig, gtMask, predMask, img_res)
